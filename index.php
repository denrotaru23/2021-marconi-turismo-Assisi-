...
$json-> points[0]-> "type"= "video";
$json-> points[0]-> "url"= "video.mp4";

$json-> points[1]-> "type"= "immagine";
$json-> points[1]-> "url"= "basilica.jpg";
...
$json-> points[2]-> "type"= "immagine";
$json-> points[2]-> "url"= "affreschi.jpg";
...
$json-> points[3]-> "type"= "immagine";
$json-> points[3]-> "url"= "basinf.jpg";
